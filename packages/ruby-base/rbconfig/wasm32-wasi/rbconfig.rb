...
#
# Portable rbconfig.rb for wasm32-wasi cross-compilation.
#
# Extracted from a custom Ruby 3.3 WASM base binary build and sanitized:
# all machine-specific absolute paths replaced with relative references.
# Used by `bundle install --target-rbconfig` to cross-compile gems.
#
# This file is NOT used at runtime — it's only needed at build time so that
# Bundler/RubyGems can resolve platform-specific gem variants and compile
# native extensions for wasm32-wasi.
...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--host' 'wasm32-wasi' '--with-static-linked-ext' '--disable-install-doc'"
  ...
  CONFIG["warnflags"] = "-Wall -Wextra -Wdeprecated-declarations -Wdivision-by-zero -Wimplicit-function-declaration -Wimplicit-int -Wpointer-arith -Wwrite-strings -Wmissing-noreturn -Wno-cast-function-type -Wno-constant-logical-operand -Wno-long-long -Wno-missing-field-initializers -Wno-overlength-strings -Wno-parentheses-equality -Wno-self-assign -Wno-tautological-compare -Wno-unused-parameter -Wno-unused-value -Wunused-variable -Wmisleading-indentation -Wundef"
  CONFIG["debugflags"] = "-g"
