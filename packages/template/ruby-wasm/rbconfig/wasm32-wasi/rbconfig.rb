...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--host' 'wasm32-wasi' '--build' 'x86_64-pc-linux' '--with-static-linked-ext' '--with-ext=bigdecimal,cgi/escape,continuation,coverage,date,dbm,digest/bubblebabble,digest,digest/md5,digest/rmd160,digest/sha1,digest/sha2,etc,fcntl,fiber,gdbm,json,json/generator,json/parser,nkf,objspace,pathname,psych,racc/cparse,rbconfig/sizeof,ripper,stringio,strscan,monitor,zlib,openssl' '--with-libyaml-dir=/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/wasm32-unknown-wasip1/yaml-0.2.5/opt/usr/local' '--with-zlib-dir=/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/wasm32-unknown-wasip1/zlib-1.3.1/opt/usr/local' '--with-openssl-dir=/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/wasm32-unknown-wasip1/openssl-3.2.0/opt/usr/local' '--with-baseruby=/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/x86_64-pc-linux/baseruby-3.3/opt/bin/ruby' 'WASMOPT=/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/toolchain/binaryen/bin/wasm-opt' 'WASI_SDK_PATH=/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/toolchain/wasi-sdk' 'CC=/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/toolchain/wasi-sdk/bin/clang' 'CXX=/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/toolchain/wasi-sdk/bin/clang++' 'LD=/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/toolchain/wasi-sdk/bin/clang' 'AR=/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/toolchain/wasi-sdk/bin/llvm-ar' 'RANLIB=/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/toolchain/wasi-sdk/bin/llvm-ranlib' 'LDFLAGS=-Xlinker --stack-first -Xlinker -z -Xlinker stack-size=16777216' 'XLDFLAGS=/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/wasm32-unknown-wasip1/wasi-vfs-0.5.0/libwasi_vfs.a @/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/wasm32-unknown-wasip1/ruby-3.3-wasm32-unknown-wasip1-full-d4a5042d8aa15bd10dab349e43c2703d-ext/websocket-driver-0.7.7/ext/websocket-driver/link.filelist @/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/wasm32-unknown-wasip1/ruby-3.3-wasm32-unknown-wasip1-full-d4a5042d8aa15bd10dab349e43c2703d-ext/bcrypt-3.1.20/ext/mri/link.filelist @/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/wasm32-unknown-wasip1/ruby-3.3-wasm32-unknown-wasip1-full-d4a5042d8aa15bd10dab349e43c2703d-ext/stringio-3.1.7/ext/stringio/link.filelist @/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/wasm32-unknown-wasip1/ruby-3.3-wasm32-unknown-wasip1-full-d4a5042d8aa15bd10dab349e43c2703d-ext/js-2.7.1/ext/js/link.filelist /home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/wasm32-unknown-wasip1/ruby-3.3-wasm32-unknown-wasip1-full-d4a5042d8aa15bd10dab349e43c2703d-ext/extinit.o' 'CFLAGS=' 'XCFLAGS=-DWASM_SETJMP_STACK_BUFFER_SIZE=24576 -DWASM_FIBER_STACK_BUFFER_SIZE=24576 -DWASM_SCAN_STACK_BUFFER_SIZE=24576' 'debugflags=-g' 'cppflags=' 'wasmoptflags=-O3 -g --pass-arg=asyncify-ignore-imports' '--disable-install-doc' 'ac_cv_func_dlopen=no' 'build_alias=x86_64-pc-linux' 'host_alias=wasm32-wasi'"
  ...
  CONFIG["ARFLAGS"] = "rcD "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "clang version 17.0.6\nTarget: wasm32-unknown-wasi\nThread model: posix\nInstalledDir: /home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/toolchain/wasi-sdk/bin"
  ...
  CONFIG["STRIP"] = "strip"
  CONFIG["RANLIB"] = "/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/toolchain/wasi-sdk/bin/llvm-ranlib"
  CONFIG["OBJDUMP"] = "objdump"
  CONFIG["OBJCOPY"] = "objcopy"
  CONFIG["NM"] = "nm"
  CONFIG["LD"] = "/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/toolchain/wasi-sdk/bin/clang"
  CONFIG["CXX"] = "/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/toolchain/wasi-sdk/bin/clang++"
  CONFIG["AS"] = "as"
  CONFIG["AR"] = "/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/toolchain/wasi-sdk/bin/llvm-ar"
  CONFIG["CC"] = "$(CC_WRAPPER) /home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/toolchain/wasi-sdk/bin/clang"
  CONFIG["wasmoptflags"] = "-O3 -g --pass-arg=asyncify-ignore-imports"
  CONFIG["WASMOPT"] = "/home/aface/dev/wasm-on-rails/tutorialkit.rb/packages/template/rails-wasm/build/toolchain/binaryen/bin/wasm-opt"
